...
mov [rsp], rax
 */
void construct_MULTIPLY(CODE *code, int a, int b) {
	uint8_t machCode[] = {0x48, 0xC7, 0xC3, 0x00, 0x00, 0x00, 0x00,
	                      0x48, 0xC7, 0xC1, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8B, 0x04, 0x24, 0x48, 0xF7, 0xE3,
	                      0x48, 0x89, 0x44, 0x24, 0xF8, 0x48, 0x8B, 0x04, 0x24, 0x48, 0xF7, 0xE1, 0x48, 0x89,
	                      0x44, 0x24, 0xF0, 0x48, 0xC7, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x04, 0x24};
	memcpy(&machCode[3], &a, 4);
	memcpy(&machCode[10], &b, 4);
